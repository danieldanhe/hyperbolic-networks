...
* Slides are made with a custom class from me.  
  [`presentation.cls`](https://gist.github.com/danieldanhe/6ae42535e04d53d51e96ce9801be57a2).
...
* Tilings are modified and converted to PDF from public-domain files from Wikimedia Commons.
  [$\{3,7\}$](https://commons.wikimedia.org/wiki/File:Order-7_triangular_tiling.svg)
  [$\{4,5\}$](https://commons.wikimedia.org/wiki/File:H2-5-4-primal.svg)
  [$\{5,4\}$](https://commons.wikimedia.org/wiki/File:H2-5-4-dual.svg)
