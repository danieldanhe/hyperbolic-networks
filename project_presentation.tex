...
\begin{frame}{Visualizing the model}
  \begin{tabular}{llllll}
    ...
    \(\gamma=2.1\) & \makecell{\input{figures/poincare_model/network_2.1_20.tikz}} & \makecell{\input{figures/poincare_model/network_2.1_50.tikz}} & \makecell{\input{figures/poincare_model/network_2.1_100.tikz}} & \makecell{\input{figures/poincare_model/network_2.1_200.tikz}} & \makecell{\input{figures/poincare_model/network_2.1_500.tikz}} \\
    \(\gamma=2.5\) & \makecell{\input{figures/poincare_model/network_2.5_20.tikz}} & \makecell{\input{figures/poincare_model/network_2.5_50.tikz}} & \makecell{\input{figures/poincare_model/network_2.5_100.tikz}} & \makecell{\input{figures/poincare_model/network_2.5_200.tikz}} & \makecell{\input{figures/poincare_model/network_2.5_500.tikz}} \\
    \(\gamma=3.0\) & \makecell{\input{figures/poincare_model/network_3.0_20.tikz}} & \makecell{\input{figures/poincare_model/network_3.0_50.tikz}} & \makecell{\input{figures/poincare_model/network_3.0_100.tikz}} & \makecell{\input{figures/poincare_model/network_3.0_200.tikz}} & \makecell{\input{figures/poincare_model/network_3.0_500.tikz}} \\ \bottomrule
  \end{tabular}
\end{frame}
